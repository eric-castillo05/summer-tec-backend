...
class Materias_Propuestas(db.Model):
    ...
    id_coordinador = db.Column(db.String(36), db.ForeignKey('coordinadores.numero_control'), nullable=True)
    id_admin = db.Column(db.String(35), db.ForeignKey('admins.id'), nullable=True)
